...
import edu.vit.gravitas.Activity.Notifications;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (list.get(position).getText().equals("Share with Peers")){
                    ...
                    String app_url = "https://play.google.com/store/apps/details?id=edu.vit.gravitas";
                    Intent shareIntent =   new Intent(android.content.Intent.ACTION_SEND);
                    shareIntent.setType("text/plain");
                    String text = "Hey. I came across this brilliant app that could help you efficiently search through the clutter of events of Gravitas and find the best one that suits your need. Try it out. It is so easy to use.\n"
                            +"App Link: "+app_url;
