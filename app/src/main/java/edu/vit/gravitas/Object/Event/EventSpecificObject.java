...
public class EventSpecificObject{
    ...
    public LongLat getLatitude() {
        return latitude;
    }

    public void setLatitude(LongLat latitude) {
        this.latitude = latitude;
    }

    public LongLat getLongitude() {
        return longitude;
    }

    public void setLongitude(LongLat longitude) {
    ...
    public LongLat latitude,longitude;

    public EventSpecificObject(String shortName, String website, String info, String clubName, String videoLink, boolean isPaid, List<String> eventType, int eventCost, int likes, int timestamp, int duration, String registrationLink, String meetingLink, String poster, String venue, int views, LongLat latitude, LongLat longitude, boolean vtopRegistrations, String _id, String name, EventClubObject clubId, String createdAt, String updatedAt, int __v) {
