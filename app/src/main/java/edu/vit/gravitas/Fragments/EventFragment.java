...
import edu.vit.gravitas.Adapter.EventAdapter;
import edu.vit.gravitas.Object.Event.EventClubObject;
...
import edu.vit.gravitas.Services.Api;
    ...
    private void Onclick(){
        all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gravitas.setTextColor(getResources().getColor(R.color.whiteText));
                ...
                hackathons.setTextColor(getResources().getColor(R.color.whiteText));
                ...
                workshops.setTextColor(getResources().getColor(R.color.whiteText));
                ...
                ngo.setTextColor(getResources().getColor(R.color.whiteText));
                if (type==1){
        ...
        gravitas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                all.setTextColor(getResources().getColor(R.color.whiteText));
                gravitas.setBackground(getResources().getDrawable(R.drawable.event_selected));
                gravitas.setTextColor(getResources().getColor(R.color.black));
                riviera.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                hackathons.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                hackathons.setTextColor(getResources().getColor(R.color.whiteText));
                speakers.setBackground(getResources().getDrawable(R.drawable.event_unselected));
        ...
        hackathons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hackathons.setTextColor(getResources().getColor(R.color.black));
                speakers.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                workshops.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                workshops.setTextColor(getResources().getColor(R.color.whiteText));
                cultural.setBackground(getResources().getDrawable(R.drawable.event_unselected));
        ...
        workshops.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                workshops.setTextColor(getResources().getColor(R.color.black));
                cultural.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                ngo.setBackground(getResources().getDrawable(R.drawable.event_unselected));
                ngo.setTextColor(getResources().getColor(R.color.whiteText));
                if (type==6){
        ...
        ngo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ngo.setTextColor(getResources().getColor(R.color.black));
                if (type==8){
